...
package org.jhapy.registry.config.info;
...
public class CloudConfigInfoContributor implements InfoContributor {
  ...
  public CloudConfigInfoContributor(ConfigServerConfig configServerConfig,
  ...
  public void contribute(Info.Builder builder) {
    ...
    builder
        .withDetail("cloud-config-server-configuration-sources", configServerConfig.getComposite());
  }
}
